...
public abstract class Prattle {
	...
	public static void prepareVulgarMap() {
		...
		try (BufferedReader file = new BufferedReader(streamReader)) {
			...
			LOGGER.log(Level.FATAL, "File not found for parental control", e);
		} catch (IOException e) {
			LOGGER.log(Level.FATAL, "IO Exception when trying to read file for parental control", e);
		}
	}
	...
	public static void changeLog(String level) {
		...
		if (level.equalsIgnoreCase("info")) {
			console_appender.setThreshold(Level.INFO);
		} else if (level.equalsIgnoreCase("debug")) {
			console_appender.setThreshold(Level.DEBUG);
		} else if (level.equalsIgnoreCase("warn")) {
			console_appender.setThreshold(Level.WARN);
		} else if (level.equalsIgnoreCase("fatal")) {
			console_appender.setThreshold(Level.FATAL);
		} else if (level.equalsIgnoreCase("off")) {
			console_appender.setThreshold(Level.OFF);
		} else if (level.equalsIgnoreCase("all")) {
			console_appender.setThreshold(Level.ALL);
		} else if (level.equalsIgnoreCase("error")) {
			console_appender.setThreshold(Level.ERROR);
		}
